    ...
    <div id="container">
    	<div id="containerConnect">
        	<div class="containerConnect">
            	<h2>Hi, @radityadika!<br />minta No. hp kamu dong: </h2>
                <form id="confirmAccount" action="berkah_non_axis.php">
                	<label>No.Hp</label>
                    <input type="text" class="numeric" maxlength="15"/>
                    <input type="submit" value="CONFIRM" />
                </form>
            </div><!-- end .containerConnect -->
        </div><!-- end #containerConnect -->
    </div><!-- end #container -->
    <div id="footer">
    	<div class="footer">
