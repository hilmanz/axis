...
<div id="body">
    ...
    <a href="register.php"  class="logoBigBarokah">&nbsp;</a>
    <div id="registerBoxBlank">
    	<div class="messageText">
        	<h1>SELAMAT GABUNG BEB!</h1>
            <p>Oh ya pastiin nomor AXIS kamu aktif dan valid ya karena <br />AXIS bakal bagi-bagi Barokah.</p>
            <a href="#" class="nextPage">LANJUT</a>
        </div>
    </div>
    <!--
    <div id="registerBoxBlank">
    	<div class="messageText">
        	<h1>MAKASIH YA UDAH DAFTAR.</h1>
            <p>Kalau bisa nanti Bebep edit pakai nomor AXIS ya<br />biar gampang nyamber hadiah Barokah dari AXIS.</p>
            <a href="#" class="nextPage">LANJUT</a>
        </div>
    </div>
     -->
