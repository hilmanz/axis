...
<link rel="stylesheet" type="text/css" href="css/axisBerkahRegister.css" />
    ...
    <div id="container">
    	<div id="messageBox">
        	<div class="messageBox">
            	<p>Gapa2 koq, Bebep belum pake no. AXIS.<br />
Kalo udah punya no. AXIS jangan lupa ya balik ke bagian edit !</p>
				<a href="berkah_landing.php" class="btn_lanjut">LANJUT</a>
            </div><!-- end .messageBox -->
            <a class="closeBtn" href="" onclick="history.back(); return false;">X</a>
        </div><!-- end #messageBox -->
    </div><!-- end #container -->
    <div id="footer">
    	<div class="footer">
