...
<link rel="stylesheet" type="text/css" href="css/axisberkahmobile.css">
...
<div id="body">
    <div id="top">
        <a class="logo right"><img src="img/mobile/logo.png" /></a>
    </div><!-- end #top -->
    <div id="bodyLogin">
        <div id="connectTwitter">
            <a href="#"><img src="img/berkah/mobile/twitter_connect.png" /></a>
